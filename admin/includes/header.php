            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <h3 class="brand-text">Contact Form Admin</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">Hello, 
                  <span class="user-name text-bold-700"><?php
                      echo htmlentities(ucfirst($_SESSION['userlogin'])); ?></span>
                </span>
                            <span class="avatar avatar-online">
                  <img src="app-assets/images/icons8-avatar-40.png"
                       alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a
                              class="dropdown-item"
                              href="change-password.php"><i class="ft-user"></i>
                                Edit Profile</a>
                  ...
                  $isread = 1;
                  $sql
                          = "SELECT id from tblcontactdata where Is_Read!=:isread";
                        ...
                        <ul
                          class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span
                                  class="notification-tag badge badge-default badge-danger float-right m-0"><?php
                                    echo htmlentities($totalcount); ?> New</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                <?php
                                $isread = 1;
                                $sql
                                        = "SELECT FullName,PostingDate,id from tblcontactdata where Is_Read!=:isread";
                                $query  = $dbh->prepare($sql);
                                ...
                                if ($query->rowCount() > 0):
                                    foreach ($results as $result):
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                <div
                                                  class="media-left align-self-center">
                                                    <i
                                                      class="ft-plus-square icon-bg-circle bg-cyan"></i>
                                                </div>
                                                <div class="media-body">
                                                    <h6 class="media-heading">
                                                        You have contact equiry
                                                        from</h6>
                                                    <p
                                                      class="notification-text font-small-3 text-muted">
                                                        <a
                                                          href="contact-details.php?cid=<?php
                                                          echo htmlentities($result->id); ?>"><?php
                                                            echo htmlentities($result->FullName); ?></a>
                                                    </p>
                                                    <small>
                                                        <time
                                                          class="media-meta text-muted"
                                                          datetime="2015-06-11T18:29:20+08:00"><?php
                                                            echo htmlentities($result->PostingDate); ?></time>
                                                    </small>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6
                                              class="media-heading yellow darken-3">
                                                No Notification</h6>
