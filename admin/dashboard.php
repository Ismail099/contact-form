                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                <?php
                                                $sql
                                                       = "SELECT id from tblcontactdata where date(PostingDate)=CURDATE()";
                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                                ...
                                                <h3 class="warning">
                                                    <?php
                                                        echo htmlentities($last7dayscount); 
                                                    ?>
                                                </h3>
                                        ...
                                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                                            <div class="progress-bar bg-gradient-x-warning" role="progressbar" style="width: 100%" aria-valuenow="65" 
                            ...
                            <div class="card-content">
                                <a href="all-contacts.php">
                                    <div class="card-body">
                                        ...
                                        <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                                            <div class="progress-bar bg-gradient-x-success" role="progressbar" style="width: 100%" aria-valuenow="75"
