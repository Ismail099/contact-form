...
// if session is valid
  ...
  if (isset($_POST['update'])) {
    $email = $_POST['email'];
    $con = "update tblemail set emailId=:email";
    $query = $dbh->prepare($con);
    $query->bindParam(':email', $email, PDO::PARAM_STR);
    $query->execute();
    $msg = "Email id succesfully changed";
  }
...
?>
  ...
  <head>
    ...
    <title>Contact Form Admin | Update Email id</title>
    ...
    <div class="app-content content">
      <div class="content-wrapper">
            ...
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"> Update Email id
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="content-body">
          ...
          <form name="email" method="post" onSubmit="return valid();">
            <section class="formatter" id="formatter">
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Email id where you want to receive email notification</h4>
                    ...
                    <div class="card-content">
                      <div class="card-body">
                          ...
                          <div class="col-xl-6 col-lg-12">
                            <fieldset>
                              ...
                              <div class="form-group">
                                ...
                                ?>
                                    <input class="form-control white_bg" id="email" name="email" type="text" value="<?php echo htmlentities($result->emailId); ?>" required>
                                <?php
                                  endforeach;
                                endif;
                        ...
                        <div class="row">
                          <div class="col-xl-6 col-lg-12">
                            <button type="submit" name="update" class="btn btn-info btn-min-width mr-1 mb-1">Submit</button>
                          </div>
                        </div>
