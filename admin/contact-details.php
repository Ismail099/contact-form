...
// if session is valid
    ...
    if (isset($_POST['submit'])) {
        ...
        $remark = $_POST['remark'];
        $sql
                = "INSERT INTO   tbladminremarks(contactFormId,adminRemark) VALUES(:cfid,:adminrmrk)";
        $query  = $dbh->prepare($sql);
        $query->bindParam(':cfid', $formid, PDO::PARAM_STR);
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
              href="app-assets/css/pages/invoice.css">
            ...
            <div class="content-header row">
                <div
                  class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Contact
                        Details</h3>
            ...
            <div class="content-body">
                <section class="card">
                    <div id="invoice-template" class="card-body">
                        ...
                        $sql
                               = "SELECT tblcontactdata.FullName,tblcontactdata.PhoneNumber,tblcontactdata.UserIp,tblcontactdata.EmailId,tblcontactdata.Subject,tblcontactdata.Message,tblcontactdata.PostingDate,tblcontactdata.id from tblcontactdata  where tblcontactdata.id=:fid";
                        $query = $dbh->prepare($sql);
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            ...
                            <div
                              class="col-md-6 col-sm-12 text-center text-md-left">
                                <ul class="px-0 list-unstyled">
                                    <li class="text-bold-800"><?php
                                        echo htmlentities($result->FullName); ?>
                                        (IP Address : <?php
                                        echo htmlentities($result->UserIp); ?>)
                                    </li>
                                    <li><b>Phone Number : </b><?php
                                        echo htmlentities($result->PhoneNumber); ?>
                                    </li>
                                    <li><b>Email id : </b><?php
                                        echo htmlentities($result->EmailId); ?>
                                    </li>
                                    <li><b>Posting Date : </b><?php
                                ...
                                <div class="table-responsive col-sm-12">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><p><?php
                                                    echo htmlentities($result->Subject); ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php
                                        $stmt
                                                = "SELECT tbladminremarks.adminRemark,tbladminremarks.remarkDate from  tbladminremarks  where contactFormId=:fid";
                                        $query1 = $dbh->prepare($stmt);
                                        $query1->bindParam(':fid', $fid,
                                          PDO::PARAM_STR);
                                        $query1->execute();
                                        $resultss
                                        ...
                                        foreach ($resultss as $results):
                                            ?>
                                            <tr>
                                                <th scope="row">Admin Remark
                                                </th>
                                                <td><p><?php
                                                        echo htmlentities($results->adminRemark); ?>
                                                        <br/>
                                                        <b>Remark Date
                                                            :</b> <?php
                                                        echo htmlentities($results->remarkDate); ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        <?php
                                    ...
                                    <div class="modal fade text-left"
                                        ...
                                        <div class="modal-dialog"
                                            ...
                                            <div class="modal-content">
                                                <div
                                                  class="modal-header bg-warning white">
                                                    <h3
                                                      class="modal-title white"
                                                      id="myModalLabel12"><i
                                                          class="la la-file"></i>
                                                        Add admin remark here
                                                    </h3>
                                                    <button type="button"
                                                            class="close"
                                                            data-dismiss="modal"
